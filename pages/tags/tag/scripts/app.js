...
import {populatePagination} from "../../../../scripts/functions/populatePagination.js";
...
document.querySelector('.title-name').innerText = "Tag: " + tagFilter.toUpperCase();
...
if (filteredPosts.length > 0) {
    populatePosts();
    populatePagination(filteredPosts, currentPage, tagFilter);
} else {
    const postList = document.querySelector("#postList");
